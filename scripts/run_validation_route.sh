...
cat sql/core_ready/01_prepare_core_transactions.sql | docker exec -i nafadpay-postgres psql -U admin -d nafadpay -f -

echo "Validation and core-ready preparation completed."